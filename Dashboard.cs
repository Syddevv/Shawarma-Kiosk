...
namespace Admin_Login
{
    public partial class Dashboard : Form
    {
        ...
        private void wrapMeals_Click_1(object sender, EventArgs e)
        {
            new wrapmeals().Show();
            this.Hide();
        }
        ...
        private Image ByteArrayToImage(byte[] oleFieldBytes)
        {
            if (oleFieldBytes == null || oleFieldBytes.Length == 0)
                return null;
            ...
            try
            {
                ...
                {
                    int imageStartIndex = (oleFieldBytes.Length > OleHeaderLength && oleFieldBytes[0] == 0x15) ? OleHeaderLength : 0;
                    ms.Write(oleFieldBytes, imageStartIndex, oleFieldBytes.Length - imageStartIndex);
