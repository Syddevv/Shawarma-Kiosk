...
{
    public partial class addProductInventory : Form
    {
        private inventory parentForm;
        public addProductInventory(inventory parent)
        {
            InitializeComponent();
            parentForm = parent;
        }
        ...
        private void AddProductToInventory(string productName, int quantity, DateTime dateTimeUpdated)
        {
            ...
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                try
                {
                    ...
                    string insertQuery = @"
                INSERT INTO [Inventory Per Measurement] 
                ([ingredients_name], [ingredients_measurement_grams], [date_time_updated], [quantity_update]) 
