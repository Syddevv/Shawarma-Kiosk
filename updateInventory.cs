...
namespace Admin_Login
{
    public partial class updateInventory : Form
    {
        ...
        public updateInventory(string ingredientName, int currentQuantity)
        {
            InitializeComponent();
        ...
        private void UpdateInventoryDatabase(string ingredientName, int newQuantity, string formattedQuantityDifference)
        {
            ...
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                try
                {
                    ...
                    string updateQuery = @"
                UPDATE [Inventory Per Measurement] 
                SET [ingredients_measurement_grams] = @newQuantity, 
                ...
                WHERE [ingredients_name] = @ingredientName";
                    ...
                    using (OleDbCommand command = new OleDbCommand(updateQuery, connection))
                    {
                        ...
                        command.Parameters.Add("@quantityDifference", OleDbType.VarChar).Value = formattedQuantityDifference; // Update the field with formatted value
        ...
        private void DeleteProductFromDatabase(string ingredientName)
        {
            ...
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                try
                {
                    ...
                    string deleteQuery = "DELETE FROM [Inventory Per Measurement] WHERE [ingredients_name] = @ingredientName";
